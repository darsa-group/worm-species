...
CONFIG_FIELDS: tuple[ConfigField, ...] = (
    ...
    _field("wandb.log_model", bool, default=False, consumers=("wandb",), categories=("logging",)),
    _field("wandb.compact", bool, default=False, consumers=("wandb",), categories=("logging",)),
    _field("data.root_dir", str, required_in=("training",), consumers=("metadata", "dataset", "cache"), categories=("storage",)),
    _field("data.metadata_csv", str, required_in=("training",), consumers=("metadata",), categories=("storage",)),
    _field("data.colour_retention", int, float, default=1.0, range_description="[0, 1]", consumers=("compatibility normalization",), status="legacy"),
    ...
    _field("data.min_individuals_per_class", int, default=1, range_description=">= 0", consumers=("metadata",)),
    ...
    _field("data.barcode_col", str, default="barcode", consumers=("taxonomy",)),
    _field("data.species_requires_binomial", bool, default=True, consumers=("taxonomy",)),
    ...
    _field("data.missing_label_values", list, default=(), consumers=("taxonomy", "labels")),
    _field("data.min_individuals_per_class_by_task", dict, default={}, consumers=("metadata",)),
    _field("data.min_individuals_per_class_by_task.*", int, range_description=">= 0", consumers=("metadata",)),
    _field("data.sampler.type", str, default="default", choices=("default", "joint_species_stage", "cross_species_stage_contrastive"), consumers=("training loader",)),
    _field("data.sampler.replacement", bool, default=True, consumers=("training loader",)),
    _field("data.sampler.samples_per_epoch", int, type(None), default=None, range_description="> 0", consumers=("training loader",)),
    _field("data.sampler.species_per_stage", int, default=3, range_description="> 0", consumers=("training loader",)),
    _field("data.sampler.individuals_per_species_stage", int, default=2, range_description="> 0", consumers=("training loader",)),
    _field("data.sampler.images_per_individual", int, default=1, range_description="> 0", consumers=("training loader",)),
    _field("data.multiview.enabled", bool, default=False, consumers=("training loader", "model")),
    _field("data.multiview.images_per_individual", int, default=3, range_description="> 0", consumers=("training loader",)),
    _field("data.multiview.image_sampling", str, default="random", choices=("random", "first"), consumers=("training loader",)),
    _field("data.multiview.pooling", str, default="mean", choices=("mean",), consumers=("model",)),
    _field("data.multiview.evaluation_max_images", int, type(None), default=None, range_description="> 0", consumers=("evaluation",)),
    _field("data.taxonomic_uncertainty.uncertain_species_labels", list, default=(), consumers=("taxonomy",)),
    _field("data.taxonomic_uncertainty.uncertain_species_patterns", list, default=(), consumers=("taxonomy",)),
    _field("data.taxonomic_uncertainty.resolved_species_label_overrides", dict, default={}, consumers=("taxonomy",)),
    _field("data.taxonomic_uncertainty.life_stage_overrides", dict, default={}, consumers=("taxonomy",)),
    _field("data_holdout", dict, default={}, consumers=("split filtering", "evaluation")),
    _field("data_holdout.enabled", bool, default=False, consumers=("split filtering",)),
    _field("data_holdout.name", str, consumers=("run naming", "evaluation")),
    _field("data_holdout.question", str, consumers=("evaluation",)),
    ...
    _field("augmentation.gaussian_blur.enabled", bool, default=False, consumers=("training transforms",)),
    _field("augmentation.gaussian_blur.probability", int, float, default=0.5, range_description="[0, 1]", consumers=("training transforms",)),
    _field("augmentation.gaussian_blur.kernel_size", int, default=5, range_description="positive odd integer", consumers=("training transforms",)),
    _field("augmentation.gaussian_blur.sigma", list, default=(0.1, 2.0), range_description="two positive ascending values", consumers=("training transforms",)),
    ...
    _field("model.multitask_architecture", str, default="shared_heads", choices=("shared_heads", "single_task", "split_taxonomy_age"), consumers=("model", "losses", "metrics")),
    _field("model.target_task", str, type(None), default=None, choices=("genus", "species", "age", None), consumers=("model", "loaders", "metrics")),
    _field("model.branch_mode", str, default="auto", choices=("auto", "duplicated_final_stage", "residual_adapter"), consumers=("model",)),
    _field("model.adapter_dim", int, default=256, range_description="> 0", consumers=("model",)),
    _field("model.adapter_dropout", int, float, default=0.2, range_description="[0, 1]", consumers=("model",)),
    _field("model.pooling.type", str, default="global_average", choices=("global_average", "task_attention"), consumers=("model",)),
    _field("model.pooling.dropout", int, float, default=0.1, range_description="[0, 1]", consumers=("model",)),
    _field("model.age_species_adversary.enabled", bool, default=False, consumers=("model", "losses")),
    _field("model.age_species_adversary.weight", int, float, default=0.05, range_description=">= 0", consumers=("losses",)),
    _field("model.age_species_adversary.warmup_epochs", int, default=10, range_description=">= 0", consumers=("training",)),
    _field("model.age_species_adversary.max_weight", int, float, default=0.1, range_description=">= 0", consumers=("model",)),
    _field("loss.age_supervised_contrastive.enabled", bool, default=False, consumers=("model", "losses")),
    _field("loss.age_supervised_contrastive.weight", int, float, default=0.1, range_description=">= 0", consumers=("losses",)),
    _field("loss.age_supervised_contrastive.temperature", int, float, default=0.07, range_description="> 0", consumers=("losses",)),
    _field("loss.age_supervised_contrastive.cross_species_positives", bool, default=True, consumers=("losses",)),
    _field("loss.genus_supervised_contrastive.enabled", bool, default=False, consumers=("model", "losses")),
    _field("loss.genus_supervised_contrastive.weight", int, float, default=0.05, range_description=">= 0", consumers=("losses",)),
    _field("loss.genus_supervised_contrastive.temperature", int, float, default=0.07, range_description="> 0", consumers=("losses",)),
    _field("loss.genus_supervised_contrastive.cross_species_positives", bool, default=True, consumers=("losses",)),
    _field("loss.genus_supervised_contrastive.projection_dim", int, default=128, range_description="> 0", consumers=("model",)),
    _field("loss.taxonomy_consistency.enabled", bool, default=False, consumers=("losses",)),
    _field("loss.taxonomy_consistency.weight", int, float, default=0.05, range_description=">= 0", consumers=("losses",)),
    _field("loss.taxonomy_consistency.direction", str, default="symmetric", choices=("direct", "symmetric", "symmetric_kl", "jensen_shannon", "js"), consumers=("losses",)),
    ...
    _field("training.gradient_diagnostics.enabled", bool, default=False, consumers=("training",)),
    _field("training.gradient_diagnostics.interval_steps", int, default=100, range_description="> 0", consumers=("training",)),
    _field("training.gradient_strategy.type", str, default="standard", choices=("standard", "pcgrad"), consumers=("optimiser",)),
    _field(
        "training.mode",
        str,
        default="multitask",
    ...
    _field(
        "training.use_masked_labels",
        bool,
        default=True,
        consumers=("loaders", "losses", "metrics"),
    ),
    ...
    _field("training.staged_unfreezing.enabled", bool, default=False, consumers=("training", "optimiser")),
    _field("training.staged_unfreezing.heads_only_epochs", int, default=5, range_description=">= 0", consumers=("training",)),
    _field("training.staged_unfreezing.task_branches_epoch", int, default=5, range_description=">= 0", consumers=("training",)),
    _field("training.staged_unfreezing.full_backbone_epoch", int, default=15, range_description=">= 0", consumers=("training",)),
    _field("optimizer.type", str, default="adamw", choices=("adamw",), consumers=("optimiser",)),
    _field("optimizer.learning_rates", dict, type(None), default=None, consumers=("optimiser",)),
    _field("optimizer.learning_rates.*", int, float, range_description="> 0", consumers=("optimiser",)),
    _field("optimizer.weight_decay", int, float, default=0.0001, range_description=">= 0", consumers=("optimiser",)),
    _field("evaluation.checkpoint_ensemble.enabled", bool, default=False, consumers=("checkpoints", "evaluation")),
    _field("evaluation.checkpoint_ensemble.top_k", int, default=3, range_description="> 0", consumers=("checkpoints", "evaluation")),
    _field("evaluation.checkpoint_ensemble.aggregation", str, default="mean_probability", choices=("mean_probability",), consumers=("evaluation",)),
    _field("evaluation.individual_level.enabled", bool, default=False, consumers=("evaluation", "checkpoints")),
    _field("evaluation.individual_level.aggregation", str, default="mean_probability", choices=("mean_probability",), consumers=("evaluation",)),
    ...
    _field("cache.condition_variants.enabled", bool, default=False, consumers=("condition cache", "loaders")),
    ...
    _field("colour_ablation.step_percent", int, default=1, range_description="> 0", consumers=("compatibility normalization",), status="legacy"),
    _field("colour_ablation.combine_with_sweep", bool, default=False, consumers=("compatibility normalization",), status="legacy"),
