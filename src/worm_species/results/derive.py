...
``worm_species.results``.  It never opens a checkpoint, runs inference, or
...
def _derive_run(
    ...
    *,
    ...
    expected_tasks = {"genus", "species", "age"}
    fallback_mean = None
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--cache",
        type=Path,
        default=Path(".cache/worm-species-dashboard/derived"),
